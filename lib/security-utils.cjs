...
// NOTE: File size limits removed to support large files with embedded content (hundreds of MB)
// The following constants are kept for backward compatibility but no longer enforced:
/** @deprecated No longer enforced - kept for backward compatibility */
const MAX_SVG_SIZE = Infinity;
/** @deprecated No longer enforced - kept for backward compatibility */
const MAX_JSON_SIZE = Infinity;
...
function readJSONFileSafe(filePath, validator = null) {
  ...
  // NOTE: File size limit removed to support large JSON files
