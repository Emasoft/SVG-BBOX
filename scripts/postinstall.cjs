...
function printWelcome() {
  ...
  console.log(row(''));
  console.log(row(`${c.cyan}${c.bold}  svg-bbox${c.reset} ${c.dim}v${version}${c.reset}  ${c.green}installed successfully!${c.reset}`));
  ...
  console.log(row(`  ${c.dim}$${c.reset} ${c.cyan}svg-bbox --help${c.reset}          ${c.dim}# Show all commands${c.reset}`));
  console.log(row(`  ${c.dim}$${c.reset} ${c.cyan}sbb-getbbox icon.svg${c.reset}     ${c.dim}# Get bounding box${c.reset}`));
  console.log(row(`  ${c.dim}$${c.reset} ${c.cyan}sbb-extract file.svg -l${c.reset}  ${c.dim}# List all objects${c.reset}`));
  console.log(row(''));
